...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> EntityProjectFolderPrefix =
        CVarDef.Create("autogen.entity_project.folder_prefix", "_, Nyanotrasen, SimpleStation14", CVar.ARCHIVE);
    ...
    public static readonly CVarDef<string> WikiProjectPrefix =
        CVarDef.Create("autogen.wiki.project_prefix", "Frontier", CVar.SERVERONLY | CVar.ARCHIVE);
}
